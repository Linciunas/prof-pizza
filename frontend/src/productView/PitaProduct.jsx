...
const PitaProduct = () => {
    ...
    return (
        <div className='h-full'>
            <BlackHeader url = {"/pita-gyros"} showKebab = {true} showPizza = {false} ></BlackHeader>
            <div className='bg-blue-300 pt-20 pb-5 justify-center flex h-full'>
                <div className='grid grid-cols-2 grid-row-5 gap-y-6 max-w-[400px]'>
                    <div className='flex items-center justify-center'>
                        <img src = {pita.src} className='h-[283px]'></img>
                    </div>
                    <div>
                        <div className='h-1/2 justify-center flex items-center'>
                            <div className='flex flex-row items-end gap-5 w-[163px]'>
                                <img src = {pita.numberSrc} className='w-10 h-10'></img>
                        ...
                        <div className='h-1/2 justify-center flex text-[16px] items-baseline'>
                            <div>
                                {pita.ingredients.map((ingredient, index) => 
                    ...
                    <div className="col-span-2 pt-20px flex justify-center text-xl gap-1" onChange={(e) => onChangeSize(e)}>
                        ...
                        <label htmlFor="lg" className='size-radiobox-text w-[45%]'>{t("size.large")}</label>
                    </div>
